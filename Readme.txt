...
Данный репозиторий был предназначен для обучения:
...
3. Java Core
  ...
  8. Знакомство с потоками InputStreamOutputStream, FileInputStream, FileOutputStream
  9. Знакомство с потоками ReaderWriter, FileReaderFileWriter, FileReaderFileWriter
  10. Сериализация
